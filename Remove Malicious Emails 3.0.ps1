...
$str001 = "Remove Malicious Emails Ver 3.0"
...
$str007 = "In order to connect with MFA account you need to install Exchange Online PowerShell multi-factor authentication"
$str008 = "Connect to Security and Compliance Center"
$str009 = "Use MFA"
$str010 = "Connection Status:"
$str011 = "Not Connected to Security and Compliance Center"
...
$str032 = "Connecting"
$str033 = "Orange"
$str034 = "Wrong creds or no creds entered ..."
...
$ConnectButton.text                        = $str008
$ConnectButton.location                    = New-Object System.Drawing.Point(300,50)
$ConnectButton.Size                        = New-Object System.Drawing.Size(300,30)
#
$MFACheckBox                               = new-object 'System.Windows.Forms.checkbox'
$MFACheckBox.Text                          = $str009
$MFACheckBox.Location                      = new-object System.Drawing.Size(630,40)
$MFACheckBox.Size                          = new-object System.Drawing.Size(180,50)
...
function MFA () 
{
    ...
    else 
    {
        try
        {
            $StatusUpdate.Text = $str032
            $StatusUpdate.Forecolor = $str033
            $StatusUpdate.location = New-Object System.Drawing.Point(400,110)
...
Function TestConnection()
{
    Try
    {
        ...
        $form.controls.remove($ConnectButton)
        $form.controls.remove($MFACheckBox)
